...
# output file name
output_file_name = 'output_v2.csv'
...
def main():
    ...
    try:
        ...
        cars_data_df['cars_key'] = cars_data_df['Brand, model, trim, price_Model year'].astype(str).str.lower() + ' ' + cars_data_df[
            'Brand, model, trim, price_Brand'].astype(str).str.lower() + ' ' + cars_data_df['Brand, model, trim, price_Model'].astype(str).str.lower()
        ...
        gov_data_df['gov_key'] = gov_data_df['YearFirstUsed'].astype(str).str.lower() + ' ' + gov_data_df[
            'Make'].astype(str).str.lower() + ' ' + gov_data_df['Model'].astype(str).str.lower()
