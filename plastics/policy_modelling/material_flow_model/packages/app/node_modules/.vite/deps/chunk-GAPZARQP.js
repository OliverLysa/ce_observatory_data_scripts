// node_modules/@sdeverywhere/runtime/node_modules/neverthrow/dist/index.es.js
...
var Ok = (
  ...
  function() {
    function Ok2(value) {
      var _this = this;
      this.value = value;
      this.match = function(ok2, _err) {
        return ok2(_this.value);
      };
    }
    ...
    Ok2.prototype._unsafeUnwrap = function() {
      return this.value;
    };
    Ok2.prototype._unsafeUnwrapErr = function() {
...
var Err = (
  ...
  function() {
    function Err2(error) {
      var _this = this;
      this.error = error;
      this.match = function(_ok, err2) {
        return err2(_this.error);
      };
    }
    ...
    Err2.prototype._unsafeUnwrap = function() {
      throw new Error("Called `_unsafeUnwrap` on an Err");
    };
    Err2.prototype._unsafeUnwrapErr = function() {
      return this.error;
    };
    return Err2;
  }()
...
var ResultAsync = (
  ...
  function() {
    ...
    ResultAsync2.fromPromise = function(promise, errorFn) {
      ...
      if (errorFn) {
        newPromise = newPromise["catch"](function(e) {
    ...
    ResultAsync2.prototype.then = function(successCallback) {
...
// node_modules/@sdeverywhere/runtime/dist/index.js
...
neverthrow/dist/index.es.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-GAPZARQP.js.map
