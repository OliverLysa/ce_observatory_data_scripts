...
#Parameters coming from frontend
...
try:
    ...
    frontend_params = { "policy1 introduction time": 2043, "policy2 introduction time": 2043 }
...
for scenario in scenarios:
    ...
    initial_values = {
        ...
        "policy1 introduction time": 2043,
    ...
    # Merge initial values and frontend params with rates_dict

    rates_dict = {**initial_values, **rates_dict, **frontend_params }
...
total_model_output['material'] = total_model_output['material'].replace({'Pet': 'PET'})
